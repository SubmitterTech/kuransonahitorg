...
# Load the Quran data
quran_tr = load_json('qurantft.json')
...
save_json(verses_map, 'verses_eng.json')
save_json(titles_map, 'titles_eng.json')
#save_json(first_indexed_titles, 'suras_eng.json')
save_json(notes_map, 'notes_eng.json')
